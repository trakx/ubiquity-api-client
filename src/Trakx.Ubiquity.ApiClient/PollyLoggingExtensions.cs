...
/// <summary>
/// Extensions methods for logging unexpected failures occurring when using an external API.
/// </summary>
public static class PollyLoggingExtensions
{
    ...
    /// <param name="context">The Polly context in which the failure occurred.</param>
